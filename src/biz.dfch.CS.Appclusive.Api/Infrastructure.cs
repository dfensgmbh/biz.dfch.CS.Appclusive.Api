...
{
    public partial class Infrastructure : global::System.Data.Services.Client.DataServiceContext, IDataServiceClientHelper, IOdataActionHelper
    {
        ...
        public string TenantHeaderName
        {
            get
            {
                ...
                {
                    this.tenantHeaderName = Infrastructure.DEFAULT_TENANT_HEADER_NAME;
                }
        ...
        private bool SetBasicAuthenticationHeader()
        {
            ...
            if (this.Credentials is NetworkCredential)
            {
                ...
                {
                    setHeader = Infrastructure.AuthorisationBaererUserName != networkCredentials.UserName;
                }
            }
            return setHeader;
        }
        ...
        private void RegisterSendingRequestEvent()
        {
            ...
            {
                this.SendingRequest2 += Infrastructure_SendingRequest2;
            }
            else
            {
                this.SendingRequest2 -= Infrastructure_SendingRequest2;
        ...
        void Infrastructure_SendingRequest2(object sender, SendingRequest2EventArgs e)
        {
            if (this.SetBearerAuthenticationHeader())
            {
                NetworkCredential networkCredentials = (NetworkCredential)this.Credentials;
                e.RequestMessage.SetHeader(Infrastructure.AUTHORIZATION_HEADER_NAME, string.Format(Infrastructure.AUTHORIZATION_BEARER_SCHEME, networkCredentials.Password));
            }
            ...
            if (this.SetBasicAuthenticationHeader())
            {
                ...
                e.RequestMessage.SetHeader(Infrastructure.AUTHORIZATION_HEADER_NAME, string.Format(Infrastructure.AUTHORIZATION_BASIC_SCHEME, basicAuthString));
            }
        ...
        {
            var methodName = "POST";
            string entityUrl = Infrastructure.GetEntityUrl(entitySetName, id);

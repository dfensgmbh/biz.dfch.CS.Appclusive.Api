...
{
    public partial class Csm : global::System.Data.Services.Client.DataServiceContext, IDataServiceClientHelper, IOdataActionHelper
    {
        ...
        public string TenantHeaderName
        {
            get
            {
                ...
                {
                    this.tenantHeaderName = Csm.DEFAULT_TENANT_HEADER_NAME;
                }
        ...
        private bool SetBasicAuthenticationHeader()
        {
            ...
            if (this.Credentials is NetworkCredential)
            {
                ...
                {
                    setHeader = Csm.AuthorisationBaererUserName != networkCredentials.UserName;
                }
            }
            return setHeader;
        }
        ...
        private void RegisterSendingRequestEvent()
        {
            ...
            {
                this.SendingRequest2 += Csm_SendingRequest2;
            }
            else
            {
                this.SendingRequest2 -= Csm_SendingRequest2;
        ...
        void Csm_SendingRequest2(object sender, SendingRequest2EventArgs e)
        {
            if (this.SetBearerAuthenticationHeader())
            {
                NetworkCredential networkCredentials = (NetworkCredential)this.Credentials;
                e.RequestMessage.SetHeader(Csm.AUTHORIZATION_HEADER_NAME, string.Format(Csm.AUTHORIZATION_BEARER_SCHEME, networkCredentials.Password));
            }
            ...
            if (this.SetBasicAuthenticationHeader())
            {
                ...
                e.RequestMessage.SetHeader(Csm.AUTHORIZATION_HEADER_NAME, string.Format(Csm.AUTHORIZATION_BASIC_SCHEME, basicAuthString));
            }
        ...
        {
            var methodName = "POST";
            string entityUrl = Csm.GetEntityUrl(entitySetName, id);
